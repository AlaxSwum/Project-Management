...
export default function LoginPage() {
  ...
  // Warm up Supabase connection on mount — DNS + TLS + connection pool ready before user clicks login
  useEffect(() => {
    supabase.from('auth_user').select('id', { head: true, count: 'exact' }).limit(1).then(() => {});
  }, []);
