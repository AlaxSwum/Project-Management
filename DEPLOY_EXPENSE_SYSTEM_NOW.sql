-- DEPLOY EXPENSE MANAGEMENT SYSTEM IN SUPABASE SQL EDITOR NOW
...
-- Success message
SELECT 'SUCCESS: Expense Management System with folder permissions deployed successfully!' as result;
