          ...
          >
            ...
            <div style={{
              ...
              <p style={{
                ...
                Schedule and organize your personal tasks with time blocking. Drag tasks to specific time slots for better productivity.
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h3 style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '0.25rem' }}>15-Min Time Blocks</h3>
                  <p style={{ fontSize: '0.875rem', color: '#6b7280', margin: '0' }}>Precise scheduling with 15-minute intervals</p>
                </div>
                <div style={{
                  background: '#f8fafc',
                  border: '1px solid #e5e7eb',
                  ...
                  <p style={{ fontSize: '0.875rem', color: '#6b7280', margin: '0' }}>Easily move tasks between time slots</p>
                </div>
              </div>
              ...
              <div style={{
                ...
                🚧 Calendar views (Month, Week, Day with 15-min blocks) are coming soon! This feature will integrate with your personal tasks for complete time management.
              </div>
            </div>
          )}
