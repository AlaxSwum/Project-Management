...
# Database - PostgreSQL for production (Hostinger supports PostgreSQL)
DATABASES = {
    'default': {
...
# Static files storage - WhiteNoise for serving static files
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://www.your-frontend-domain.com",  # Replace with your frontend domain
]
