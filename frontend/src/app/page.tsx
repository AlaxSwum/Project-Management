        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto px-4 sm:px-0">
              <Link 
                href="/login" 
                className="bg-gradient-to-r from-[#FFB333] to-[#FFD480] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:from-[#F29F0A] hover:to-[#FFB333] transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-center"
              >
                Get Started
              </Link>
              <Link 
                href="/login" 
                className="border-2 border-[#FFB333] text-[#FFB333] px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-[#FFB333] hover:text-white transition-all duration-200 text-center"
              >
                View Demo
              </Link>
            </div>
      ...
      <section id="features" className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Task Management */}
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
              <div className="text-3xl sm:text-4xl font-bold text-[#FFB333] mb-2">10K+</div>
              <div className="text-sm sm:text-base text-gray-600 font-medium">Active Projects</div>
            </div>
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
              <div className="text-3xl sm:text-4xl font-bold text-[#5884FD] mb-2">50K+</div>
              <div className="text-sm sm:text-base text-gray-600 font-medium">Happy Users</div>
            </div>
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
              <div className="text-3xl sm:text-4xl font-bold text-[#C483D9] mb-2">99.9%</div>
              <div className="text-sm sm:text-base text-gray-600 font-medium">Uptime</div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-center">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#FFB333] rounded-full flex items-center justify-center mr-3">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <span className="text-sm sm:text-base text-gray-700">Intuitive project planning</span>
                </li>
                <li className="flex items-center">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#FFB333] rounded-full flex items-center justify-center mr-3">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">Advanced reporting</span>
                </li>
              </ul>
            </div>
            <div className="bg-gradient-to-br from-[#FFB333] to-[#FFD480] p-6 sm:p-8 rounded-2xl">
              <div className="bg-white p-4 sm:p-6 rounded-xl">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Ready to get started?</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Join thousands of teams already using Focus Project to manage their work.</p>
                <Link 
                  href="/login" 
                  className="bg-gradient-to-r from-[#FFB333] to-[#FFD480] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:from-[#F29F0A] hover:to-[#FFB333] transition-all duration-200 inline-block text-center w-full sm:w-auto"
                >
                  Start Free Trial
                </Link>
              </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-gray-900 to-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto px-4 sm:px-0">
            ...
            <Link 
              href="/login" 
              className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-white hover:text-gray-900 transition-all duration-200 text-center"
            >
              Contact Sales
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <span className="text-base sm:text-lg font-bold text-gray-900">Focus Project</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-600">
                <li><a href="#" className="hover:text-[#FFB333] transition-colors">About</a></li>
                <li><a href="#" className="hover:text-[#FFB333] transition-colors">Blog</a></li>
                <li><a href="#" className="hover:text-[#FFB333] transition-colors">Careers</a></li>
                <li><a href="#" className="hover:text-[#FFB333] transition-colors">Contact</a></li>
              </ul>
            </div>
