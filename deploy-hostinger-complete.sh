...
echo "🚀 Starting Complete Hostinger Deployment..."
...
print_step "1/8 - Cleaning up previous installations..."
...
apt update
apt install -y curl git python3 python3-pip python3-venv nginx
...
print_step "3/8 - Cloning clean project from GitHub..."
cd /var/www
...
# STEP 4: Setup Backend with Supabase
print_step "4/8 - Configuring backend with Supabase..."
...
cat > .env << 'EOF'
# Django Settings
SECRET_KEY=your-super-secret-production-key-d394e696cb467d25947bc6efb2d79d36e465e18f-clean-version
DEBUG=False
...
# JWT Configuration
JWT_SECRET_KEY=jwt-secret-key-for-clean-deployment-d394e696cb467d25947bc6efb2d79d36e465e18f
...
echo "from django.contrib.auth.models import User; User.objects.create_superuser('admin', 'admin@project.com', 'admin123') if not User.objects.filter(username='admin').exists() else None" | python manage.py shell

print_status "Backend configured with Supabase!"

# STEP 5: Create Backend Service
print_step "5/8 - Creating backend service..."
...
# STEP 6: Setup Frontend with Google Drive OAuth
print_step "6/8 - Configuring frontend with Google Drive OAuth..."
...
print_step "7/8 - Creating frontend service..."
...
print_step "8/8 - Configuring Nginx..."
...
echo "--- Backend Status ---"
systemctl status gunicorn-pm --no-pager -l
...
echo ""
echo "🌟 Google Drive OAuth is ready!"
echo "Make sure your Google Cloud Console is configured with:"
echo "📍 Authorized origins: https://srv875725.hstgr.cloud"
echo "📍 Authorized redirect URIs: https://srv875725.hstgr.cloud" 